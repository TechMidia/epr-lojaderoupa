...
class AccountMoveLine(models.Model):
    ...
    def _search(self, domain, *args, **kwargs):
        ...
        # TODO: This replacement of the condition (leaf) by Domain.FALSE won't work in all cases. It only works if the domain is recon_at_date_domain.OR(original_domain)
